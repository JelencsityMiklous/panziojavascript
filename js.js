function Szamolas(){
    ...
    let eletkorok = [Number(document.getElementById("eletkor1").value),Number(document.getElementById("eletkor2").value),Number(document.getElementById("eletkor3").value),Number(document.getElementById("eletkor4").value)]


    let eletkorokhelyessege=true;
    let kiskoru=0;
    let nagykoru=0;
    for(let eletkor of eletkorok){
        if(Number.isNaN(eletkor)){
            eletkorokhelyessege=false;
        }
        if(eletkor!="" && eletkor<16){
            kiskoru++;
        }
        if(eletkor!="" && eletkor>16){
            nagykoru++;
